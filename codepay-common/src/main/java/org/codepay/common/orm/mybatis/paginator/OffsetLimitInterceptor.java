package org.codepay.common.orm.mybatis.paginator;
...
import org.codepay.common.orm.mybatis.paginator.domain.Pagination;
import org.codepay.common.orm.mybatis.paginator.support.PropertiesHelper;
import org.codepay.common.orm.mybatis.paginator.support.SQLHelp;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;


/**
 * @Descriptions  * 为MyBatis提供基于方言(Dialect)的分页查询的插件  将拦截Executor.query()方法实现分页方言的插入.
 * @date 2015-2-9
 * @author codeWatching
 */
...
public class OffsetLimitInterceptor implements Interceptor{
	...
	public Object intercept(final Invocation invocation) throws Throwable {
        ...
        Callable<Pagination> countTask = null;
        ...
        if(countTask!=null){
            Future<Pagination> countFutrue = call(countTask, async);
